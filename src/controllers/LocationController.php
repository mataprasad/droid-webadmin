...
class LocationController
{
    ...
    {
        return $this->view->render($response, 'location/index.php', []);
    }
    ...
    public function list(Request $request, Response $response, $args)
    {
        ...
        if ($query==null) {
            $data = $this->db->table('DtLocationMaster')->get();
        } else {
            $data = $this->db->table('DtLocationMaster')
    ...
    public function edit(Request $request, Response $response, $args)
    {
        ...
        $data = $this->db->table('DtLocationMaster')->where("ID", "=", $query)->first();
